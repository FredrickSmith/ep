...
pq.cmd  = require 'command'
pq.util = require 'util'
pq.file = require 'file'
pq.oop  = require 'oop'

pq.cmd.add ('quit', 'Quit', 'Ends session.', pq.util.rt, false)


pq.cmd.add ('a', 'a', 'GetAppDataForActivitySelection\nScrape Collections', function ()
...
pq.cmd.add ('b-a', 'b-a', 'StoreActivityUsageData3\nSelected', function ()
	local a = pq.file.read 'in'
...
pq.cmd.add ('b-b', 'b-b', 'StoreActivityUsageData3\nModule'  , function ()
	local a = pq.file.read 'in'
...
pq.cmd.add ('c-a', 'c-a', 'StoreActivityProgress2\nSelected', function ()
...
pq.cmd.add ('c-b', 'c-b', 'StoreActivityProgress2\nModule', function ()
	local _f = pq.file.read 'in'
...
print (F[[====================================]]..
       ...
       F[[====================================]]..
       F[[| Commands:                         ]]..
      (F[[|	%s|		%s]]):rep (pq.cmd.count ()):format (pq.cmd.unpack ())..
       F[[====================================]]..
       F[[| Toodle Doo:                       ]]..
      (F[[|	%s        ]]):rep (#pq.util.todo):format (table.unpack (pq.util.todo))..
       F[[====================================]])
while true do
	local a = pq.cmd.getall () [io.read ():lower ()]
          a = a and a [3] or pq.cmd.ic
